...
void* manejar_cliente_cpu(void* datos_hilo_cpu_void)
{
  ...
  while (true)
  {
    ...
    switch (op_code)
    {
      ...
      {
        logger_info(datos_hilo_cpu->ms_recursos->logger, "## Recibiendo instrucción de lectura de parte de la cpu");
        ...
        logger_info(datos_hilo_cpu->ms_recursos->logger, "## Lectura de %d bytes, desde %d por parte de la cpu", cantidad_bytes, posicion_inicial);
      ...
      {
        logger_info(datos_hilo_cpu->ms_recursos->logger, "## Recibiendo instrucción de escritura de parte de la cpu");
        t_list* paquete = recibir_paquete(datos_hilo_cpu->socket_cpu);
