...
void* escuchar_kernel_memory(void* arg)
{
  ...
  while (1)
  {
    ...
    insertar_nodo_ultimo(&cpu->hilos.kernel_memory_hilo,
                         crear_nodo(ip_stick, puerto_stick, nuevo_socket));
...
void insertar_nodo_ultimo(t_nodo_lista_memory_stick** lista,
                          t_memory_stick elemento)
{
