...
SCHEDULING_ALGORITHM=MULTILEVEL, QUEUE_ALGORITHMS=[FIFO,RR,FIFO,RR], RR_QUANTUM=600, SUSPENSION_TIMEOUT=60000; ALLOCATION_STRATEGY=BEST, SEGMENT_MAX_SIZE=128; 1 memory stick (256 B); 1 CPU.
