...
SCHEDULING_ALGORITHM=MULTILEVEL, QUEUE_ALGORITHMS=[FIFO,RR,RR,RR], RR_QUANTUM=1500, SUSPENSION_TIMEOUT=35000; SEGMENT_MAX_SIZE=256; 1 memory stick (256 B); 1 CPU.
