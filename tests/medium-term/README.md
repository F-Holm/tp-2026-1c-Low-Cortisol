...
SCHEDULING_ALGORITHM=MULTILEVEL, QUEUE_ALGORITHMS=[FIFO,FIFO,FIFO,FIFO], SUSPENSION_TIMEOUT=10000; SEGMENT_MAX_SIZE=128; 4 memory sticks (16, 16, 32, 64 B); 1 CPU.
